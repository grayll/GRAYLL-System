...
//gryusd
func (cache *RedisCache) SetGRYUsd(price float64) (bool, error) {
	return cache.client.HSet("prices", "gryUsd", price).Result()
}
func (cache *RedisCache) GetGRYUsd() (float64, error) {
	return cache.client.HGet("prices", "gryUsd").Float64()
}

//grzusd
func (cache *RedisCache) SetGRZUsd(price float64) (bool, error) {
	return cache.client.HSet("prices", "grzUsd", price).Result()
}
func (cache *RedisCache) GetGRZUsd() (float64, error) {
	return cache.client.HGet("prices", "grzUsd").Float64()
}

// Get/set LAS params of function2
...
// algorithm cache
func (cache *RedisCache) GetNewGrayllTxId() (string, error) {
	cache.client.Incr("GrayllTxId")
	return cache.client.Get("GrayllTxId").Result()
}
